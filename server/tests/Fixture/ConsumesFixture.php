 ...
 *
 */
class ConsumesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'unit' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'quantity' => 1,
                'created' => '2018-07-04 16:17:45',
                'modified' => '2018-07-04 16:17:45'
            ],
        ];
        parent::init();
    }
